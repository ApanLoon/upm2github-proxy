...
namespace UnitTests.Serialization
{
    public class SearchResultTests
    {
        ...
        private readonly SearchResult result0 = new SearchResult 
        {
            ...
            //Total = 1,
            Time = DateTimeOffset.Parse("Wed, 16 Mar 2022 22:57:02 GMT")
        };
